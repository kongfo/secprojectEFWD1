...
Feature: F14_user can opens facebook/twitter/rss/Youtube pages
  ...
  Scenario: SC14- user can opens facebook page
  ...
  Scenario: SC15- user can opens twitter page
    When user click twitter
    Then verify that it opens twitter page


  Scenario: SC16- user can opens rss page

    When user click rss
    Then verify that it opens rss page


  Scenario: SC17- user can opens Youtube page
